  ...
  return (
    <div style={s.page}>
      ...
      <div style={s.card}>
        ...
        {status === 'success' && (
          <>
            <div style={{ ...s.iconWrap, background: '#4F7EFF' }}>
...
const s = {
  ...
  card: { background: '#0C1220', border: '1px solid #1A2240', borderRadius: '16px', padding: '48px 40px', width: '100%', maxWidth: '420px', textAlign: 'center' },
  iconWrap: { width: 64, height: 64, borderRadius: '50%', background: 'rgba(79,126,255,.15)', display: 'grid', placeItems: 'center', margin: '0 auto 24px' },
  spinner: { width: 32, height: 32, borderRadius: '50%', border: '3px solid #1A2240', borderTop: '3px solid #4F7EFF', animation: 'spin 1s linear infinite' },
  ...
  infoBox: { background: '#080C18', border: '1px solid #1A2240', borderRadius: '10px', padding: '16px', margin: '0 0 24px', textAlign: 'left' },
  btn: { width: '100%', background: '#4F7EFF', color: '#080C18', border: 'none', borderRadius: '10px', padding: '13px', fontSize: '15px', fontWeight: 700, fontFamily: "'Space Grotesk', sans-serif", cursor: 'pointer' },
}